...
Scenario: VerifyCreditedAmount
   ...
   # Maximize browser window. (Custom cucumber step - Find the definition at steps.web)
   #And maximize window
   ...
   # Update the value os stored balance(line no 26)(Custom cucumber step - Find the definition at steps.web)
