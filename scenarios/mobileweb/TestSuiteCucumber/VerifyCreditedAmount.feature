...
Scenario: VerifyCreditedAmount
   ...
   # Maximize browser window. (Custom cucumber step - Find the definition at steps.mobileweb)
   ...
   # Update the value os stored balance(line no 26)(Custom cucumber step - Find the definition at steps.mobileweb)
